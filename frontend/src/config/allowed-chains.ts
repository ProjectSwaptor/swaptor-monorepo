...
import { Chain, ChainWithDecimalId } from "@web3-onboard/common/dist";
...
export const mumbai = {
  ...
  token: "MATIC",
  label: "Mumbai",
  rpcUrl: CHAIN_TO_RPC[SupportedChain.Mumbai],
  icon: `
...
const chains: Record<SupportedChain, Chain | ChainWithDecimalId> = {
  [SupportedChain.Mumbai]: mumbai,
};

export const allowedChains: (Chain | ChainWithDecimalId)[] =
